...
<html>
<head>
	<title>Displaying Room Detail</title>
     <meta charset="utf-8">
...
<br/><br/>
<a type="button" class="btn btn-primary btn-sm float-right" href="http://127.0.0.1:8000/room/roomRegister">New Room</a>
<br/>
	<h1>Room Details</h1>
	...
	<table class="data-table">
		...
		@foreach($rooms as $room)
			    <tr>    
                  ...
                  <td> 	                  
	                  	<a  href="/room/roomUpdate/{{$room->id }}">
