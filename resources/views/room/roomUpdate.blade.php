...
{{Form::model($rooms, array('route' => array('roomUpdate_post', $rooms->id)))}}
...
@if($errors->any())
    ...
    <p class="h4 mb-4">ROOM UPDATE</p>

          <label for="room_number">Room Number</label>
          <input type="text"  name="room_number" value="{{ $rooms->room_number }}"   class="form-control mb-4"  required/>

          <label for="room_type">Room Type</label>
          <select name="room_type" id="room_type" value="{{ $rooms->room_type }}" class="form-control mb-4"  required>
          ...
          <input type="number"  name="room_rent" value="{{ $rooms->room_rent }}"    class="form-control mb-4"  required/>
          ...
          <input type="date" name="room_from" value="{{ $rooms->room_from }}"  class="form-control mb-4" required/>

          <label for="room_to">Booked To</label>
          <input type="date" name="room_to" value="{{ $rooms->room_to }}"  class="form-control mb-4" required/>
