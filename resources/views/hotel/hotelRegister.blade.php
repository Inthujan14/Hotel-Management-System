...
<form class="text-center border border-light p-5" method="post" action="{{ url("hotelRegister_post") }}">
...
@if($errors->any())
    ...
    <p class="h4 mb-4">HOTEL REGISTATION</p>

         <label for="hotel_name">Hotel Name</label>
          <input type="text"  name="hotel_name"   class="form-control mb-4"  required/>

          <label for="hotel_address">Address</label><br/>
          <textarea id="hotel_address" name="hotel_address" rows="6" cols="140" required></textarea>

          <label for="hotel_type">Hotel Type</label>
          <select name="hotel_type" id="hotel_type" class="form-control mb-4"  required>
